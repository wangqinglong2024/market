<!--
单角色词卡图模板(flux-pro/kontext，喂 1 张贴纸小女儿定妆图)。
- 画小女儿做该动作，可带该动作必要的道具/家具，简洁。
- ★底色=暖米色 #fee8c9(死命令)：和九宫格整页大背景一致，出图后 build 把边界底色归一到精确 #fee8c9，
  这样小图晃动时插图浮在米色上、无方框边(参考视频效果)。★不要白底、不要透明、不要 box/frame/阴影台。
- 严禁写身体部位负面词(会触发 fal nsfw 黑图)；本模板无 negative。
占位：{shot}=该动作画面(英文) {canon}=小女儿定妆 {style_short}=画风。
-->
{shot}
